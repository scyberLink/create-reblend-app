/**
 * @fileoverview Defines where Reblend component static properties should be positioned.
 * @author Daniel Mason
 */
...
ruleTester.run('static-property-placement', rule, {
  valid: parsers.all([
    // ------------------------------------------------------------------------------
    // Ignore createClass/createReblendClass and Static Functional Components
    // ------------------------------------------------------------------------------
    {
      // Do not error on createReblendClass pragma
      code: `
        var MyComponent = createReblendClass({
          childContextTypes: {
    ...
    },
    {
      ...
      code: `
        var MyComponent = Reblend.createClass({
          childContextTypes: {
            something: PropTypes.bool
          },
    ...
    },
    {
      ...
      code: `
        ...
        class OtherComponent extends Reblend.Component {
          static defaultProps = {
            name: 'Bob'
          }
