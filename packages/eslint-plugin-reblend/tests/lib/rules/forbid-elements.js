...
ruleTester.run('forbid-elements', rule, {
  valid: parsers.all([
    ...
    {
      code: 'NotReblend.createElement("button")',
      options: [{ forbid: ['button'] }],
    },
    {
      code: 'Reblend.createElement("_thing")',
      options: [{ forbid: ['_thing'] }],
    },
    {
      code: 'Reblend.createElement("Modal")',
      options: [{ forbid: ['Modal'] }],
    },
    {
      code: 'Reblend.createElement("dotted.component")',
      options: [{ forbid: ['dotted.component'] }],
    },
    {
      code: 'Reblend.createElement(function() {})',
      options: [{ forbid: ['button'] }],
    },
    {
  ...
  invalid: parsers.all([
    ...
    {
      code: 'Reblend.createElement("button", {}, child)',
      options: [{ forbid: ['button'] }],
      errors: [
        {
          messageId: 'forbiddenElement',
    ...
    {
      code: '[Reblend.createElement(Modal), Reblend.createElement("button")]',
      options: [{ forbid: ['button', 'Modal'] }],
      errors: [
        {
          messageId: 'forbiddenElement',
    ...
    {
      code: 'Reblend.createElement(_comp)',
    ...
    {
      code: 'Reblend.createElement("button", {}, Reblend.createElement("input"))',
      options: [
        {
          forbid: [{ element: 'button' }, { element: 'input' }],
        },
