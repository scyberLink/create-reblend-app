...
ruleTester.run('default-props-match-prop-types', rule, {
  valid: parsers.all([
    ...
    },
    {
      code: `
        ...
        MyStatelessComponent.propTypes.foo = Reblend.PropTypes.string;
        MyStatelessComponent.defaultProps = {
          foo: "foo"
        };
      `,
    ...
    },
    {
      code: `
        ...
        Greeting.propTypes.foo = Reblend.PropTypes.string;
        Greeting.defaultProps = {
          foo: "foo"
        };
      `,
  ...
  invalid: parsers.all([
    ...
    {
      code: `
        class SomeComponent extends Reblend.Component {
          render() {
            return <div />;
          }
        }
    ...
    },
    {
      code: `
        ...
        class Foo extends Reblend.Component<Props> {
            static defaultProps = {
              disabled: false
            };
        };
