...
ruleTester.run('no-typos', rule, {
  valid: parsers.all(
    [].concat(
      {
        code: `
          import createReblendClass from 'create-reblend-class'
      ...
      },
      {
        ...
        import PropTypes from 'prop-types';
        const Component = Reblend.createReblendClass({
          propTypes: {
      ...
      },
      {
        ...
        class Sample extends Reblend.Component {
          render() { return null; }
        }
      ...
      },
      {
        ...
        export default class MyComponent extends Reblend.Component {
          [A.B] () {
            return null
          }
        }
      ...
      {
        code: `
        const MyComponent = Reblend.forwardRef((props, ref) => <div />);
      ...
      {
        code: `
        class Editor extends Reblend.Component {
            #somethingPrivate() {
              // ...
            }
  ...
  invalid: parsers.all(
    [].concat(
      ...
      class Component extends Reblend.Component {};
      Component.propTypes = {
        a: Reblend.PropTypes.string.isrequired,
        b: Reblend.PropTypes.shape({
          c: Reblend.PropTypes.number
        }).isrequired
      }
    `,
        parserOptions,
      ...
      },
      {
        ...
        class Component extends Reblend.Component {};
        Component.childContextTypes = {
          a: Reblend.PropTypes.bools,
          b: Reblend.PropTypes.Array,
          c: Reblend.PropTypes.function,
          d: Reblend.PropTypes.objectof,
        }
      `,
        parserOptions,
        errors: [
