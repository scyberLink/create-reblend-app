...
ruleTester.run('sort-comp', rule, {
  valid: parsers.all([
    ...
    {
      code: `
        // Must validate a full Reblend 16.3 createReblendClass class
        var Hello = createReblendClass({
          displayName : '',
          propTypes: {},
          contextTypes: {},
    ...
    {
      code: `
        // Must validate Reblend 16.3 lifecycle methods with the default parser
    ...
    {
      code: `
        // Must validate a full Reblend 16.3 ES6 class
        class Hello extends Reblend.Component {
          static displayName = ''
          static propTypes = {}
          static defaultProps = {}
    ...
    {
      code: `
        // Non-reblend classes should be ignored, even in expressions
        return class Hello {
          render() {
            return <div>{this.props.text}</div>;
          }
    ...
    {
      code: `
        class ClassName extends Reblend.Component {
          static defaultProps = {};
  ...
  invalid: parsers.all([
    ...
    },
    {
      code: `
        ...
        var Hello = createReblendClass({
          render: function() {
            return Reblend.createElement("div", null, "Hello");
          },
          displayName : 'Hello',
        });
      `,
    ...
    },
    {
      code: `
        ...
        var Hello = () => {
          return class Test extends Reblend.Component {
            render () {
              return <div>Hello</div>;
            }
            onClick () {}
    ...
    },
    {
      code: `
        ...
        export default class View extends Reblend.Component {
          componentDidMountOk() {}
          getB() {}
          componentWillMount() {}
          getA() {}
