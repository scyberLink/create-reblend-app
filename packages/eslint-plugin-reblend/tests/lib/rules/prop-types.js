...
ruleTester.run('prop-types', rule, {
  valid: parsers.all(
    [].concat(
      ...
      },
      {
        ...
        function higherOrderComponent<Props>() {
          return class extends Reblend.Component<Props> {
            render() {
              return <div>{this.props.foo}</div>
            }
          }
      ...
      },
      {
        ...
        function higherOrderComponent<P: { foo: string }>() {
          return class extends Reblend.Component<P> {
            render() {
              return <div>{this.props.foo}</div>
            }
          }
      ...
      },
      {
        ...
        const withOverlayState = <P: {foo: string}>(WrappedComponent: ComponentType<P>): ComponentType<P> => (
          class extends Reblend.Component<P> {
            constructor(props) {
              super(props);
      ...
      export default class A extends Reblend.Component {
        render() {
          return (
            <span
              a={this.props.a}
    ...
    `,
      ...
      const hoc = <OP>() => () => {
        class Inner extends Reblend.Component<Props & OP> {
          render() {
            return <div />
          }
        }
    ...
    `,
      ...
      {
        code: `
        const HeaderBalance = Reblend.memo(({ cryptoCurrency }) => (
      ...
      {
        code: `
        const Label = Reblend.forwardRef(({ text }, ref) => {
      ...
      {
        code: `
        import Reblend, { forwardRef } from 'reblend';
      ...
      {
        code: `
        const Label = Reblend.memo(Reblend.forwardRef(({ text }, ref) => {
          return <div ref={ref}>{text}</div>;
        }));
        Label.propTypes = {
          text: PropTypes.string
      ...
      {
        code: `
        import Reblend, { memo, forwardRef } from 'reblend';
    ...
    `,
      ...
      },
      {
        code: `
        interface Props {
          'aria-label': string // 'undefined' PropType is defined but prop is never used eslint(reblend/no-unused-prop-types)
          // 'undefined' PropType is defined but prop is never used eslint(reblend-redux/no-unused-prop-types)
        }

        export default function Component({
          'aria-label': ariaLabel, // 'aria-label' is missing in props validation eslint(reblend/prop-types)
        }: Props): JSX.Element {
      ...
      },
      {
        ...
        function Test ({ value }: Props): Reblend.ReblendElement<Props> | null {
          if (!value) {
            return null;
          }
      ...
      },
      {
        ...
        export const Test: Reblend.FC<Props> = (props: Props) => {
      ...
      {
        code: `
        interface ThingProps extends Reblend.HTMLAttributes<HTMLDivElement> {
          thing?: number
        }
      ...
      },
      {
        ...
        export const Thing = ({ thing = 1, style, ...props }: ThingProps & Reblend.HTMLAttributes<HTMLDivElement>) => {
          return <div />;
        }
      `,
        features: ['ts', 'no-babel'],
      ...
      },
      {
        ...
        const Person: Reblend.FunctionComponent<PersonProps> = (props): Reblend.ReblendElement => (
      ...
      },
      {
        ...
        const Person: Reblend.FC<PersonProps> = (props): Reblend.ReblendElement => (
            <div>{props.username}</div>
        );
      `,
        features: ['ts', 'no-babel'],
      ...
      },
      {
        code: `
        import Reblend from 'reblend';
        const Person: Reblend.FunctionComponent<{ username: string }> = (props): Reblend.ReblendElement => (
            <div>{props.username}</div>
        );
      `,
        features: ['ts', 'no-babel'],
      ...
      {
        code: `
        import { FunctionComponent } from 'reblend';

        type PersonProps = {
            username: string;
        }
        const Person: FunctionComponent<PersonProps> = (props): Reblend.ReblendElement => (
            <div>{props.username}</div>
        );
      `,
        features: ['ts', 'no-babel'],
      ...
      {
        code: `
        import { FC } from 'reblend';
        type PersonProps = {
            username: string;
        }
        const Person: FC<PersonProps> = (props): Reblend.ReblendElement => (
            <div>{props.username}</div>
        );
      `,
        features: ['ts', 'no-babel'],
      ...
      {
        code: `
        import { FC as X } from 'reblend';
        interface PersonProps {
            username: string;
        }
        const Person: X<PersonProps> = (props): Reblend.ReblendElement => (
            <div>{props.username}</div>
        );
      `,
        features: ['ts', 'no-babel'],
      ...
      {
        code: `
        import * as X from 'reblend';
        interface PersonProps {
            username: string;
        }
        const Person: X.FC<PersonProps> = (props): Reblend.ReblendElement => (
            <div>{props.username}</div>
        );
      `,
        features: ['ts', 'no-babel'],
      },
      {
        ...
        const SomeComponent: Reblend.FC<Props> = ({ item }: Props) => {
          return item ? <></> : <></>;
        };
      `,
        features: ['ts', 'no-babel'],
      },
      {
        ...
        const SomeComponent: Reblend.FunctionComponent<
      ...
      },
      {
        ...
        const MyComponent = (props: Reblend.PropsWithChildren<{ username: string }>): Reblend.ReblendElement => {
      ...
      {
        code: `
          import Reblend, { VoidFunctionComponent } from 'reblend'
      ...
      },
      {
        code: `
          ...
          const Hello: Reblend.VoidFunctionComponent<Props> = function Hello(props) {
          const { age } = props;
      ...
      {
        code: `
          import Reblend, { VFC } from 'reblend'
      ...
      },
      {
        code: `
          ...
          const Hello: Reblend.VFC<Props> = function Hello(props) {
          const { age } = props;
      ...
      {
        code: `
        import Reblend, { ForwardRefRenderFunction  as X } from 'reblend'
      ...
      {
        code: `
        import Reblend, { ForwardRefRenderFunction } from 'reblend'
      ...
      },
      {
        ...
        type IfooProps = { e: string };
        const Foo= Reblend.forwardRef<HTMLDivElement, IfooProps>((props, ref) => {
          const { e } = props;
          return  <div ref={ref}>hello</div>;
        });
      `,
      ...
      },
      {
        ...
        import Reblend from 'reblend'
        type IfooProps = { e: string };
        const Foo= Reblend.forwardRef<HTMLDivElement, IfooProps>(function Foo(props, ref) {
          const { e } = props;
          return  <div ref={ref}>hello</div>;
        });
      `,
      ...
      {
        code: `
        import Reblend, { forwardRef as X } from 'reblend'
      ...
      },
      {
        ...
        export type Props = { children: Reblend.ReblendNode; type: "submit" | "button" };
      ...
      },
      {
        ...
        export type Props = { children: Reblend.ReblendNode; type: "submit" | "button" } & X;
      ...
      },
      {
        code: `
        type ButtonProps = ({
            children: Reblend.Node,
        } | {
            icon: Reblend.Element,
        }) & {
            label: string,
            disabled?: boolean
        } & {};

        const Button: Reblend.FC<ButtonProps> = ({ children, icon, label, disabled }: ButtonProps) => {
          return <div />;
        }
      `,
        features: ['types'],
      ...
      {
        code: `
        export default Reblend.memo(function AppIcon({
          icon,
          className,
          title,
          spinning,
      ...
      },
      {
        ...
        class ProjectNode extends Reblend.Component {
          render() {
            return <div />;
          }
        }
      ...
      },
      {
        ...
        interface SomeType<ContextType = any> {
          renderValue: (context: ContextType) => Reblend.ReblendNode;
        }
      ...
      },
      {
        ...
        const Button: Reblend.FC<IProps> = ({
          name,
          className,
          onClick,
          onMouseDown,
      ...
      {
        code: `
        import Reblend, { forwardRef, memo } from 'reblend';
        interface Props1 {
            age: number;
        }
  ...
  invalid: parsers.all(
    [].concat(
      ...
      },
      {
        ...
        var Hello = createReblendClass({
          render: function() {
            return Reblend.createElement("div", {}, this.props.name);
          }
        });
      `,
        errors: [
      ...
      },
      {
        ...
        class HelloBis extends Reblend.Component {
          render() {
            return <div>Hello {this.props.name}</div>;
          }
        }
      ...
      },
      {
        ...
        function Hello({firstname, lastname}: Props): Reblend$Element {
          return <div>Hello {firstname} {lastname}</div>;
        }
      `,
        features: ['flow'],
    ...
    `,
      ...
      {
        code: `
        class Hello extends Reblend.PureComponent {
          render() {
            return <div>Hello {this.props.name}</div>;
          }
        }
      ...
      },
      {
        ...
        class Hello extends Reblend.Component<{ person: Person }> {
          render () {
            return <div>Hello {this.props.person.lastname}</div>;
          }
        }
    ...
    `,
      ...
      {
        code: `
        export default class Controller extends Reblend.Component {
          handleAdd = id => {
      ...
      },
      {
        ...
        class ComponentX extends Reblend.Component {
          static propTypes = {
    ...
    `,
      ...
      },
      {
        ...
        const Person = (props: PersonProps<string>): Reblend.ReblendElement => (
            <div>{props.username}</div>
        );
      `,
        errors: [
      ...
      },
      {
        ...
        type IfooProps = { e: string };
          const Foo: Reblend.ForwardRefRenderFunction<HTMLDivElement, IfooProps> = function Foo (props, ref) {
          const { name } = props;
      ...
      },
      {
        ...
        export interface IProps { children: Reblend.ReblendNode; type: "submit" | "button" };
      ...
      {
        code: `
        import Reblend, { FC } from 'reblend';
      ...
      {
        code: `
        import Reblend, { FC as X } from 'reblend';
      ...
      },
      {
        ...
        const Person: Reblend.VoidFunctionComponent<PersonProps> = (props): Reblend.ReblendElement => (
            <div>{props.nonExistent}</div>
        );
      `,
        errors: [
      ...
      },
      {
        ...
        const Person: Reblend.VFC<PersonProps> = (props): Reblend.ReblendElement => (
            <div>{props.nonExistent}</div>
        );
      `,
        errors: [
