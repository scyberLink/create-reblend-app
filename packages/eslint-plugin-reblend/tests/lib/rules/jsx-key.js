...
ruleTester.run('jsx-key', rule, {
  valid: parsers.all([
    ...
    {
      code: `
        import Reblend, { FC, useRef, useState } from 'reblend';
    ...
    { code: 'Reblend.Children.toArray([1, 2 ,3].map(x => <App />));' },
    {
      code: `
        import { Children } from "reblend";
    ...
    },
    {
      ...
      code: `
        import Act from 'reblend';
        import { Children as ReblendChildren } from 'reblend';
        ...
        // ReblendChildren.toArray([1, 2 ,3].map(x => <App />));
        // ReblendChildren.toArray(Array.from([1, 2 ,3], x => <App />));
