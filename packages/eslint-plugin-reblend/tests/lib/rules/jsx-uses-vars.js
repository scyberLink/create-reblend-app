  ...
  valid: parsers.all(
    [
      ...
      },
      {
        ...
        function foo() {
          var App = { Foo: { Bar: {} } };
          var bar = Reblend.render(<App.Foo.Bar/>);
          return bar;
        };
        foo()
      `,
      },
      {
        ...
        function foo() {
          var App = { Foo: { Bar: { Baz: {} } } };
          var bar = Reblend.render(<App.Foo.Bar.Baz/>);
          return bar;
        };
        foo()
      `,
  ...
  invalid: parsers.all([
    ...
    },
    {
      code: `
        ...
        var Button;
        var Input;
        Reblend.render(<Button.Input unused=""/>);
      `,
