...
ruleTester.run('function-component-definition', rule, {
  valid: parsers.all([
    ...
    {
      code: 'var Foo = Reblend.memo(function Foo() { return <p/> })',
      options: [{ namedComponents: 'function-declaration' }],
    },
    {
      code: 'const Foo = Reblend.memo(function Foo() { return <p/> })',
      options: [{ namedComponents: 'function-declaration' }],
    },
    {
    ...
    {
      code: 'var Hello: Reblend.FC<Test> = function(props) { return <p/> }',
      options: [{ namedComponents: 'function-expression' }],
      features: ['types'],
    },
    {
      code: 'var Hello: Reblend.FC<Test> = (props) => { return <p/> }',
      options: [{ namedComponents: 'arrow-function' }],
      features: ['types'],
    },
    {
    ...
    {
      code: 'var Hello = function(props): ReblendNode { return <p/> }',
      options: [{ namedComponents: 'function-expression' }],
      features: ['types'],
    },
    {
      code: 'var Hello = (props): ReblendNode => { return <p/> }',
      options: [{ namedComponents: 'arrow-function' }],
      features: ['types'],
    },
    {
      code: 'function wrapper() { return function(props): ReblendNode { return <p/> } }',
      options: [{ unnamedComponents: 'function-expression' }],
      features: ['types'],
    },
    {
      code: 'function wrapper() { return (props): ReblendNode => { return <p/> } }',
      options: [{ unnamedComponents: 'arrow-function' }],
      features: ['types'],
    },
    {
      code: 'function Hello(props): ReblendNode { return <p/> }',
      options: [{ namedComponents: 'function-declaration' }],
      features: ['types'],
    },
  ...
  invalid: parsers.all([
    ...
    },
    {
      code: `
        function Hello(props: Test) {
          return Reblend.createElement('div');
        }
      `,
      output: `
        var Hello = function(props: Test) {
    ...
    {
      code: `
        var Hello: Reblend.FC<Test> = (props) => {
          return <div/>;
        }
      `,
      output: `
        var Hello: Reblend.FC<Test> = function(props) {
          return <div/>;
        }
      `,
      options: [{ namedComponents: 'function-expression' }],
    ...
    },
    {
      code: `
        function wrap(Component) {
          return function(props): ReblendNode {
            return <div><Component {...props}/></div>
          }
        }
      `,
