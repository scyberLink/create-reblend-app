...
ruleTester.run('no-danger-with-children', rule, {
  valid: parsers.all([
    ...
    {
      code: 'Reblend.createElement("div", { dangerouslySetInnerHTML: { __html: "HTML" } });',
    },
    {
      code: 'Reblend.createElement("div", {}, "Children");',
    },
    {
      code: 'Reblend.createElement("Hello", { dangerouslySetInnerHTML: { __html: "HTML" } });',
    },
    {
      code: 'Reblend.createElement("Hello", {}, "Children");',
    },
    {
      code: '<Hello {...undefined}>Children</Hello>',
    },
    {
      code: 'Reblend.createElement("Hello", undefined, "Children")',
    },
    {
      code: `
  ...
  invalid: parsers.all([
    ...
    },
    {
      code: `
        const props = { dangerouslySetInnerHTML: { __html: "HTML" } };
        Reblend.createElement("div", props, "Children");
      `,
      errors: [{ messageId: 'dangerWithChildren' }],
    },
    {
      code: `
        const props = { children: "Children", dangerouslySetInnerHTML: { __html: "HTML" } };
        Reblend.createElement("div", props);
      `,
      errors: [{ messageId: 'dangerWithChildren' }],
    },
    {
