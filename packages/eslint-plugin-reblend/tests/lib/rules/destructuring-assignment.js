...
ruleTester.run('destructuring-assignment', rule, {
  valid: parsers.all([
    ...
    {
      code: `
        class Input extends Reblend.Component {
          id = \`\${this.props.name}\`;
          render() {
            return <div />;
          }
    ...
    {
      code: `
        class C extends Reblend.Component {
          componentDidMount() {
    ...
    {
      code: `
        import { useContext } from 'reblend';
      ...
      `,
      options: ['always'],
      settings: { reblend: { version: '16.9.0' } },
    },
    {
      code: `
        import { useContext } from 'reblend';
    ...
    },
    {
      ...
      `,
      options: ['always'],
      settings: { reblend: { version: '16.8.999' } },
    },
    {
      code: `
        const MyComponent = (props) => {
