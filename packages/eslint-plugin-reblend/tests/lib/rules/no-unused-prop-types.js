  ...
  valid: parsers.all([
    ...
    },
    {
      ...
      code: `
        ...
        SomeComponent.propTypes = {
            a: Reblend.PropTypes.func.isRequired,
            b: Reblend.PropTypes.string.isRequired,
            c: Reblend.PropTypes.string.isRequired,
        };
      `,
    },
    {
    ...
    },
    {
      ...
      code: `
        export default class NavigationButton extends Reblend.Component {
         static propTypes = {
    ...
    },
    {
      ...
      code: `
        ...
        Component.propTypes = {
         children: Reblend.PropTypes.node,
        };
      `,
    },
    {
      ...
      code: `
        ...
        Thing.propTypes = {
            enabled: Reblend.PropTypes.bool,
            test: Reblend.PropTypes.bool
        };
      `,
    },
    {
      ...
      code: `
        ...
        Test.propTypes = {
          property: Reblend.propTypes.string.isRequired,
          property2: Reblend.propTypes.string.isRequired
        }
      `,
    },
    {
      // issue 811
      code: `
        const Button = Reblend.createClass({
        displayName: "Button",

        propTypes: {
            name: Reblend.PropTypes.string.isRequired,
            isEnabled: Reblend.PropTypes.bool.isRequired
        },
    ...
    },
    {
      ...
      code: `
        ...
        class DigitalServices extends Reblend.Component {
         props: Props
         render() {
           const { foo } = this.props;
    ...
    },
    {
      code: `
        ...
        class MyComponent extends Reblend.Component<void, Props, void> {
          render() {
            return <div>Hello {this.props.firstname}</div>
          }
        }
    ...
    },
    {
      code: `
        ...
        class MyComponent extends Reblend.Component<Props> {
          render() {
            return <div>Hello {this.props.firstname}</div>
          }
        }
    ...
    },
    {
      code: `
        class Test extends Component<{}, {selectedId: string}> {
          ...
          onChange = ({id}: {id: string}) => { // This will say: 'id' PropType is defined but prop is never used (reblend/no-unused-prop-types)
            this.setState({
              selectedId: id,
            });
          };
    ...
    [].concat(
      {
        ...
        var Hello = createReblendClass({
          ...
          render: function() {
            return Reblend.createElement("div", {}, this.props.value);
          }
        });
      `,
        errors: [
      ...
      },
      {
        ...
        code: `
        import Reblend from "reblend";
        var Hello = Reblend.createReblendClass({
         propTypes: {
           name: Reblend.PropTypes.string
         },
         render: function() {
...

      {
        ...
        class TestComponent extends Reblend.Component<Props> {
          public render() {
            return <div>{this.props.firstname}</div>;
          }
        }
...

      {
        ...
        var Hello = Reblend.createClass({
          propTypes: {
            ...
            propTypes: Reblend.PropTypes.string
          },
          render: function() {
            return <div>Hello {this.props.name}</div>;
          }
      ...
      },
      {
        ...
        const Demo: Reblend.FC<props> = ({ foo }) => {
          return <div {...{}}>{foo}</div>;
        };
