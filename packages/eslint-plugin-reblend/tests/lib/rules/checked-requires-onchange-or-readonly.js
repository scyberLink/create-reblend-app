...
ruleTester.run('checked-requires-onchange-or-readonly', rule, {
  valid: parsers.all([
    ...
    "Reblend.createElement('input')",
    "Reblend.createElement('input', { checked: true, onChange: noop })",
    "Reblend.createElement('input', { checked: false, onChange: noop })",
    "Reblend.createElement('input', { checked: true, readOnly: true })",
    "Reblend.createElement('input', { checked: true, onChange: noop, readOnly: true })",
    "Reblend.createElement('input', { checked: foo, onChange: noop, readOnly: true })",
    {
  ...
  invalid: parsers.all([
    ...
    {
      code: 'Reblend.createElement("input", { checked: false })',
      errors: [{ messageId: 'missingProperty' }],
    },
    {
      code: 'Reblend.createElement("input", { checked: true, defaultChecked: true })',
      errors: [
        { messageId: 'exclusiveCheckedAttribute' },
        { messageId: 'missingProperty' },
      ],
