# Enforce proper position of the first property in JSX (`reblend/jsx-first-prop-new-line`)
...
```jsx
"reblend/jsx-first-prop-new-line": `"always" | "never" | "multiline" | "multiprop" | "multiline-multiprop"`
```
