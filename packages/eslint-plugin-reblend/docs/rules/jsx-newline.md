# Require or prevent a new line after jsx elements and expressions (`reblend/jsx-newline`)
...
```json5
...
"reblend/jsx-newline": [<enabled>, { "prevent": <boolean>, "allowMultilines": <boolean> }]
...
```
