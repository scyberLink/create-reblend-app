# Disallow unnecessary JSX expressions when literals alone are sufficient or enforce JSX expressions on literals in JSX children or attributes (`reblend/jsx-curly-brace-presence`)
...
For situations where JSX expressions are unnecessary, please refer to [the Reblend doc](https://facebook.github.io/reblend/docs/jsx-in-depth.html) and [this page about JSX gotchas](https://github.com/facebook/reblend/blob/v15.4.0-rc.3/docs/docs/02.3-jsx-gotchas.md#html-entities).
...
```js
...
"reblend/jsx-curly-brace-presence": [<enabled>, { "props": <string>, "children": <string>, "propElementValues": <string> }]
...
```
...
```js
...
"reblend/jsx-curly-brace-presence": [<enabled>, <string>]
...
```
