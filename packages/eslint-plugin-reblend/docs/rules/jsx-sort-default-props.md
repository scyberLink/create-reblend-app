# Enforce defaultProps declarations alphabetical sorting (`reblend/jsx-sort-default-props`)

❌ This rule is deprecated. It was replaced by [`reblend/sort-default-props`](sort-default-props.md).
...
```js
...
"reblend/jsx-sort-default-props": [<enabled>, {
  "ignoreCase": <boolean>,
}]
...
```
