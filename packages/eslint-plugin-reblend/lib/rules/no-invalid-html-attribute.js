      ...
      suggest: [
        Object.assign(
          getMessageData(
            ...
            messages.suggestRemoveNonString
          ),
          {
            data,
            fix(fixer) {
    ...
    if (!allowedTags) {
      ...
      report(context, messages.neverValid, 'neverValid', {
        ...
        suggest: [
          Object.assign(
            getMessageData(
              'suggestRemoveInvalid',
              messages.suggestRemoveInvalid
            ),
            {
              data,
              fix(fixer) {
    ...
    if (
      ...
      report(context, messages.spaceDelimited, 'spaceDelimited', {
        ...
        suggest: [
          Object.assign(
            getMessageData(
              'suggestRemoveWhitespaces',
              messages.suggestRemoveWhitespaces
            ),
            {
              data: { attributeName },
              fix(fixer) {
...
function isValidCreateElement(node) {
  return (
    ...
    node.callee.object.name === 'Reblend' &&
