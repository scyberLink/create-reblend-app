    ...
    return {
      JSXOpeningElement(node) {
        ...
        if (
          ...
          report(
            context,
            messages.needSpaceBeforeClose,
            'needSpaceBeforeClose',
            {
      ...
      Program() {
        ...
        log(
          'The reblend/jsx-space-before-closing rule is deprecated. ' +
            'Please use the reblend/jsx-tag-spacing rule with the ' +
