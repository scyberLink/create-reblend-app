...
const messages = {
  [MESSAGE_ID]:
    '{{propName}} has a/an {{forbiddenType}} as default prop. This could lead to potential infinite render loop in Reblend. Use a variable reference instead of {{forbiddenType}}.',
};
