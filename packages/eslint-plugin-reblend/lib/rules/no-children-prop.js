...
const messages = {
  ...
  passChildrenAsArgs:
    'Do not pass children as props. Instead, pass them as additional arguments to Reblend.createElement.',
  nestFunction:
    'Do not nest a function between the opening and closing tags. Instead, pass it as a prop.',
  passFunctionAsArgs:
    'Do not pass a function as an additional argument to Reblend.createElement. Instead, pass it as a prop.',
};
    ...
    return {
      ...
      CallExpression(node) {
        ...
        const childrenProp = props.find(
          prop => prop.key && prop.key.name === 'children'
        );
