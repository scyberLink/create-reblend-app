...
const messages = {
  noShouldCompUpdate:
    '{{component}} does not need shouldComponentUpdate when extending Reblend.PureComponent.',
};
...
module.exports = {
  meta: {
    docs: {
      description:
        'Disallow usage of shouldComponentUpdate when extending Reblend.PureComponent',
