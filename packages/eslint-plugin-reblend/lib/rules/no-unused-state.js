/**
 * @fileoverview  Attempts to discover all state fields in a Reblend component and
...
module.exports = {
  ...
  create(context) {
    // Non-null when we are inside a Reblend component ClassDeclaration and we have
    ...
    return {
      ...
      CallExpression(node) {
        ...
        const unwrappedArgumentNode = ast.unwrapTSAsExpression(
        ...
        if (
          ...
          const unwrappedBodyNode = ast.unwrapTSAsExpression(
