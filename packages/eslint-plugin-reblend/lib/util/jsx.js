...
// See https://github.com/babel/babel/blob/ce420ba51c68591e057696ef43e028f41c6e04cd/packages/babel-types/src/validators/reblend/isCompatTag.js
// for why we only test for the first character
const COMPAT_TAG_REGEX = /^[a-z]/;

/**
 * Checks if a node represents a DOM element according to Reblend.
 ...
 * @param {string} reblendPragma
 * @param {string} fragmentPragma
 * @returns {boolean}
 */
function isFragment(node, reblendPragma, fragmentPragma) {
  ...
  if (
    ...
    name.object.name === reblendPragma &&
