...
const ReblendndHooksESLintPlugin = require('eslint-plugin-react-hooks');
const ReblendHooksESLintRule =
  ReblendHooksESLintPlugin.rules['exhaustive-deps'];
    ...
    },
    {
      code: normalizeIndent`
        function MyComponent({ maybeRef2, foo }) {
          ...
          const [state2, setState2] = Reblend.useState();
          const [state3, dispatch1] = useReducer();
          const [state4, dispatch2] = Reblend.useReducer();
          ...
          const [isPending3] = Reblend.useTransition();
          const [isPending4, startTransition4] = Reblend.useTransition();
    ...
    },
    {
      ...
      code: normalizeIndent`
        function MyComponent(props) {
          ...
          let [, dispatch] = Reblend.useReducer();
  ...
  invalid: [
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useCallback has a missing dependency: 'props.foo'. " +
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useCallback has a missing dependency: 'props.foo?.bar.baz'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useCallback has a missing dependency: 'props.foo?.bar'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has a missing dependency: 'local'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has a missing dependency: 'setCount'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            'Reblend Hook useMemo does nothing when called with only one argument. ' +
            'Did you forget to pass an array of dependencies?',
          suggestions: undefined,
        },
        {
          message:
            'Reblend Hook useCallback does nothing when called with only one argument. ' +
            'Did you forget to pass an array of dependencies?',
          suggestions: undefined,
        },
      ],
    ...
    },
    {
      ...
      errors: [
        {
          message:
            'Reblend Hook useEffect requires an effect callback. ' +
            'Did you forget to pass a callback to the hook?',
          suggestions: undefined,
        },
        {
          message:
            'Reblend Hook useLayoutEffect requires an effect callback. ' +
            'Did you forget to pass a callback to the hook?',
          suggestions: undefined,
        },
        {
          message:
            'Reblend Hook useCallback requires an effect callback. ' +
            'Did you forget to pass a callback to the hook?',
          suggestions: undefined,
        },
        {
          message:
            'Reblend Hook useMemo requires an effect callback. ' +
            'Did you forget to pass a callback to the hook?',
          suggestions: undefined,
        },
      ],
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has missing dependencies: 'local1' and 'local2'. " +
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has a missing dependency: 'local2'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
              desc: 'Update the dependencies array to be: [local1, local2]',
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useMemo has an unnecessary dependency: 'local2'. " +
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useCallback has a missing dependency: 'local2'. " +
            'Either include it or remove the dependency array. ' +
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has a duplicate dependency: 'local'. " +
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useCallback has an unnecessary dependency: 'window'. " +
            'Either exclude it or remove the dependency array. ' +
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useCallback has an unnecessary dependency: 'local'. " +
            'Either exclude it or remove the dependency array.',
          suggestions: [
            {
              desc: 'Update the dependencies array to be: []',
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has a missing dependency: 'history'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has a missing dependency: 'history.foo'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has missing dependencies: 'bar', 'baz', and 'foo'. " +
            'Either include them or remove the dependency array.',
          suggestions: [
            {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            'Reblend Hook useEffect was passed a dependency list that is not an ' +
    ...
    },
    {
      ...
      errors: [
        ...
        {
          message:
            'Reblend Hook useEffect has a spread element in its dependency array. ' +
    ...
    },
    {
      ...
      errors: [
        ...
        {
          message:
            'Reblend Hook useEffect has a complex expression in the dependency array. ' +
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has a missing dependency: 'props.items'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has a missing dependency: 'items'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useCallback has an unnecessary dependency: 'props.foo'. " +
            'Either exclude it or remove the dependency array.',
          suggestions: [
            {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useCallback has missing dependencies: 'props.bar' and 'props.foo'. " +
            'Either include them or remove the dependency array.',
          suggestions: [
            {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useCallback has a missing dependency: 'local'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
              desc: 'Update the dependencies array to be: [local]',
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useCallback has an unnecessary dependency: 'local.id'. " +
            'Either exclude it or remove the dependency array.',
          suggestions: [
            {
              desc: 'Update the dependencies array to be: [local]',
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useCallback has a missing dependency: 'color'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useCallback has an unnecessary dependency: 'props.foo.bar.baz'. " +
            'Either exclude it or remove the dependency array.',
          suggestions: [
            {
              desc: 'Update the dependencies array to be: [props.foo]',
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useCallback has missing dependencies: 'props.foo.bar.baz' and 'props.foo.fizz.bizz'. " +
            'Either include them or remove the dependency array.',
          suggestions: [
            {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useCallback has a missing dependency: 'props'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
              desc: 'Update the dependencies array to be: [props]',
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useCallback has an unnecessary dependency: 'local1'. " +
            'Either exclude it or remove the dependency array.',
          suggestions: [
            {
              desc: 'Update the dependencies array to be: []',
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has a missing dependency: 'props.foo'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
              desc: 'Update the dependencies array to be: [props.foo]',
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has missing dependencies: 'props.bar' and 'props.foo'. " +
            'Either include them or remove the dependency array.',
          suggestions: [
            {
              desc: 'Update the dependencies array to be: [props.bar, props.foo]',
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has missing dependencies: 'b', 'd', 'e', and 'f'. " +
            'Either include them or remove the dependency array.',
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has missing dependencies: 'a', 'b', 'c', 'd', 'e', 'f', and 'g'. " +
            'Either include them or remove the dependency array.',
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has missing dependencies: 'local', 'props.bar', and 'props.foo'. " +
            'Either include them or remove the dependency array.',
          suggestions: [
            {
    ...
    },
    {
      ...
      errors: [
        ...
        {
          message:
            "Reblend Hook useMemo has a missing dependency: 'props.foo'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
              desc: 'Update the dependencies array to be: [props.foo]',
        ...
        {
          message:
            "Reblend Hook Reblend.useEffect has a missing dependency: 'props.foo'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
              desc: 'Update the dependencies array to be: [props.foo]',
        ...
        {
          message:
            "Reblend Hook Reblend.useCallback has a missing dependency: 'props.foo'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
              desc: 'Update the dependencies array to be: [props.foo]',
        ...
        {
          message:
            "Reblend Hook Reblend.useMemo has a missing dependency: 'props.foo'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
              desc: 'Update the dependencies array to be: [props.foo]',
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useCustomEffect has a missing dependency: 'props.foo'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
              desc: 'Update the dependencies array to be: [props.foo]',
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has a missing dependency: 'state'. " +
            'Either include it or remove the dependency array. ' +
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has missing dependencies: 'props.color' and 'props.someOtherRefs'. " +
            'Either include them or remove the dependency array.',
          suggestions: [
            {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has unnecessary dependencies: 'ref1.current' and 'ref2.current'. " +
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has an unnecessary dependency: 'ref.current'. " +
            'Either exclude it or remove the dependency array. ' +
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useCallback has unnecessary dependencies: 'activeTab', 'ref1.current', and 'ref2.current'. " +
            'Either exclude them or remove the dependency array. ' +
            "Mutable values like 'ref1.current' aren't valid dependencies " +
            "because mutating them doesn't re-render the component.",
          suggestions: [
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useImperativeHandle has a missing dependency: 'props.hello'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has a missing dependency: 'props'. " +
            'Either include it or remove the dependency array. ' +
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has missing dependencies: 'props' and 'skillsCount'. " +
            'Either include them or remove the dependency array. ' +
            `However, 'props' will change when *any* prop changes, so the ` +
            `preferred fix is to destructure the 'props' object outside ` +
            `of the useEffect call and refer to those specific ` +
      ...
      errors: [
        {
          message:
            // value2
            `Assignments to the 'value2' variable from inside Reblend Hook useEffect ` +
        ...
        },
        {
          message:
            // value
            `Assignments to the 'value' variable from inside Reblend Hook useEffect ` +
            `will be lost after each render. To preserve the value over time, ` +
            `store it in a useRef Hook and keep the mutable value in the '.current' property. ` +
            `Otherwise, you can move this variable directly inside useEffect.`,
          suggestions: undefined,
        },
        {
          message:
            // value4
            `Assignments to the 'value4' variable from inside Reblend Hook useEffect ` +
            `will be lost after each render. To preserve the value over time, ` +
            `store it in a useRef Hook and keep the mutable value in the '.current' property. ` +
            `Otherwise, you can move this variable directly inside useEffect.`,
          suggestions: undefined,
        },
        {
          message:
            // asyncValue
            `Assignments to the 'asyncValue' variable from inside Reblend Hook useEffect ` +
            `will be lost after each render. To preserve the value over time, ` +
            `store it in a useRef Hook and keep the mutable value in the '.current' property. ` +
            `Otherwise, you can move this variable directly inside useEffect.`,
          suggestions: undefined,
      ...
      errors: [
        {
          message:
            ...
            `rendered by Reblend, copy 'myRef.current' to a variable inside the effect, ` +
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has a missing dependency: 'local4'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has an unnecessary dependency: 'window'. " +
            'Either exclude it or remove the dependency array. ' +
            "Outer scope values like 'window' aren't valid dependencies " +
            "because mutating them doesn't re-render the component.",
          suggestions: [
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has an unnecessary dependency: 'MutableStore.hello'. " +
            'Either exclude it or remove the dependency array. ' +
    ...
    },
    {
      ...
      errors: [
        {
          message:
            'Reblend Hook useEffect has unnecessary dependencies: ' +
    ...
    },
    {
      ...
      errors: [
        {
          message:
            'Reblend Hook useCallback has unnecessary dependencies: ' +
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has a missing dependency: 'handleNext1'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
        ...
        {
          message:
            "Reblend Hook useLayoutEffect has a missing dependency: 'handleNext2'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
        ...
        {
          message:
            "Reblend Hook useMemo has a missing dependency: 'handleNext3'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has a missing dependency: 'count'. " +
            'Either include it or remove the dependency array. ' +
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has missing dependencies: 'count' and 'increment'. " +
            'Either include them or remove the dependency array. ' +
            `You can also do a functional update 'setCount(c => ...)' if you ` +
            `only need 'count' in the 'setCount' call.`,
          suggestions: [
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has a missing dependency: 'increment'. " +
            'Either include it or remove the dependency array. ' +
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has a missing dependency: 'tick'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            `Reblend Hook useEffect has a missing dependency: 'podcasts'. ` +
            `Either include it or remove the dependency array.`,
    ...
    },
    {
      ...
      errors: [
        {
          message:
            `Reblend Hook useEffect has a missing dependency: 'fetchPodcasts'. ` +
            `Either include it or remove the dependency array. ` +
    ...
    },
    {
      ...
      errors: [
        {
          message:
            `Reblend Hook useEffect has missing dependencies: 'fetchPodcasts' and 'fetchPodcasts2'. ` +
            `Either include them or remove the dependency array. ` +
            `If 'fetchPodcasts' changes too often, ` +
            `find the parent component that defines it and wrap that definition in useCallback.`,
          suggestions: [
    ...
    },
    {
      ...
      errors: [
        {
          message:
            `Reblend Hook useEffect has an unnecessary dependency: 'fetchData'. ` +
            `Either exclude it or remove the dependency array.`,
          suggestions: [
            {
              desc: 'Update the dependencies array to be: []',
    ...
    },
    {
      ...
      errors: [
        {
          message:
            `Reblend Hook useEffect contains a call to 'setState'. ` +
    ...
    },
    {
      ...
      errors: [
        {
          message:
            `Reblend Hook useEffect contains a call to 'setData'. ` +
            `Without a list of dependencies, this can lead to an infinite chain of updates. ` +
            `To fix this, pass [] as a second argument to the useEffect Hook.`,
          suggestions: [
            {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useCallback has an unnecessary dependency: 'foo'. " +
            'Either exclude it or remove the dependency array.',
          suggestions: [
            {
              desc: 'Update the dependencies array to be: []',
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useCallback has a missing dependency: 'prop'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has a missing dependency: 'otherThing'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has a missing dependency: 'myEffect'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            'Reblend Hook useEffect received a function whose dependencies ' +
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has missing dependencies: 'foo.bar' and 'props.foo.bar'. " +
            'Either include them or remove the dependency array.',
          suggestions: [
            {
  ...
  valid: [
    {
      ...
      code: normalizeIndent`
        function MyComponent() {
          const ref = useRef() as Reblend.MutableRefObject<HTMLDivElement>;
          useEffect(() => {
            console.log(ref.current);
          }, []);
        }
    ...
    },
    {
      code: normalizeIndent`
        function MyComponent() {
          const [state, setState] = Reblend.useState<number>(0);
  ...
  invalid: [
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has a missing dependency: 'bar'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has missing dependencies: 'pizza.crust' and 'pizza?.toppings'. " +
            'Either include them or remove the dependency array.',
          suggestions: [
            {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has a missing dependency: 'pizza.crust'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
    ...
    // Regression test.
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useEffect has a missing dependency: 'props.upperViewHeight'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook useMemo has an unnecessary dependency: 'state'. " +
            'Either exclude it or remove the dependency array.',
          suggestions: [
            {
              desc: 'Update the dependencies array to be: []',
  ...
  invalid: [
    ...
    // It doesn't use any explicit types but any JS is still valid TS.
    {
      ...
      errors: [
        {
          message:
            "Reblend Hook Reblend.useEffect has a missing dependency: 'Component'. " +
            'Either include it or remove the dependency array.',
          suggestions: [
            {
